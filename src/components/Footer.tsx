    ...
    <footer className="bg-gray-900 text-gray-300 pt-12 pb-6">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <a href="#" className="block mb-2 hover:text-primary">Contactez nous </a>
        ...
        <div>
          ...
          <div className="relative">
            <input type="email" placeholder="Votre Email" className="w-full py-2 px-4 bg-gray-800 rounded-full focus:outline-none focus:ring-2 focus:ring-primary" />
            <button className="absolute right-0 top-0 bg-primary text-white py-2 px-4 rounded-full">S'inscrire</button>
          </div>
        </div>
      </div>
      <div className="border-t border-gray-800 mt-8 pt-8 text-center">
        ...
        <p className="mt-2">
          Designed By <a href="https://htmlcodex.com" className="text-primary"></a>
